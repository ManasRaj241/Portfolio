    ...
    aws: [
      {
        ...
        description:
          "Production-grade serverless notification platform built with AWS services and Terraform IaC. Features async event processing with SQS, CloudWatch monitoring with custom dashboard and 8 alarms, and runs entirely on AWS free tier.",
        technologies: [
          "AWS Lambda",
          "Terraform",
          "Python",
        ...
        category: "aws",
        highlights: [
          "Deployed with Terraform IaC - 6 AWS services in 12 modular files",
          "Async event processing with SQS queues and Dead Letter Queue",
          "CloudWatch dashboard with 8 proactive alarms for monitoring",
          "3 Python Lambda functions with environment variable configuration",
          "Runs 100% FREE within AWS free tier limits",
          "RESTful API with CORS-enabled API Gateway endpoints",
          "Event-driven architecture with decoupled message processing",
        ],
        architecture: [
          "AWS Lambda (3 Python functions)",
          ...
          "CloudWatch (Dashboard + 8 alarms + log groups)",
